...
<div class="text-center text-3xl font-thin">Todos To Do</div>
<div class="flex-grow px-28 flex justify-center items-start">
    <div class="flex flex-col w-1/2">
        <div class="flex justify-center items-start space-x-2 mb-2">
            <input 
                class="form-input focus:ring-0 border 
                border-gray-300 inset-5 flex-grow  px-2 py-1"
                type="text" placeholder="Enter a todo..."
                bind:value={description}>

            <input type="button" 
                class="shadow-lg border border-gray-400 bg-blue-400 text-white rounded text-center w-16 py-1" 
                on:click={addToDo} value="Add" >
        </div>
